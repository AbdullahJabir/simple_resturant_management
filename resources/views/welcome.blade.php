                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                              ...
                              <li class="item dinner" id="{{$item->category->slug}}">
                                    ...
                                    <a href="#">
                                        <img src="{{asset('uploads/item/'.$item->image)}}" class="img-responsive" alt="Iteam" style="height: 300px;width: 366px" >
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="https://github.com/AbdullahJabir/resturant_management_system_laravel">Abdullah Jabir Al gazi.</a> Theme by <a href="http://themewagon.com/"  target="_blank"></a>
                            </p>
                        </div>
                    </div>
                </div>
